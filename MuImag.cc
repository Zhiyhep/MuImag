...
namespace {
  void PrintUsage() {
    G4cerr << " Usage: " << G4endl;
    G4cerr << " MuImag [-m macro ] [-u UIsession] [-t nThreads]" << G4endl;
...
int main(int argc,char** argv)
{
  ...
  G4Random::setTheSeed((G4int)time(0));  
...
/*
 ifdef G4MULTITHREADED
...
#endif*/
  auto runManager = new G4RunManager;
  runManager->SetPrintProgress(10);//Set PrintModulo
  ...
  auto actionInitialization = new MuActionInitialization("rawdata.root",detConstruction);
